...
const CommentDialog = ({
  ...
  async function postComment() {
    try {
      const res = await axios.post(
        `https://snapverse-production-9bac.up.railway.app/post/addcomment/${post._id}`,
        { text },
  ...
  async function likeOrDislike() {
    try {
      const res = await axios.post(
        `https://snapverse-production-9bac.up.railway.app/post/likeordislike/${post._id}`,
        {},
        { withCredentials: true }
      );
      if (res.status === 200) {
  ...
  const savedPost = async () => {
    try {
      const res = await axios.post(
        `https://snapverse-production-9bac.up.railway.app/post/save/${post._id}`,
        {},
        { withCredentials: true }
      );
  ...
  async function deletePost() {
    try {
      const res = await axios.delete(
        `https://snapverse-production-9bac.up.railway.app/post/delete/${post._id}`,
        { withCredentials: true }
      );
      if (res.status === 200) {
        toast.success(res.data);
  ...
  async function fetchUserProfile() {
    try {
      const res = await axios.get(
        `https://snapverse-production-9bac.up.railway.app/user/profile/${userProfile._id}`,
        {
          withCredentials: true,
        }
      );
